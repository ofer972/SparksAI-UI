...
export default function GoalsPanel({
  ...
  useEffect(() => {
    if (showConnectEpicsModal && goalToConnectEpics && ((scopeType === 'pi' && piName) || (scopeType === 'sprint' && sprintId) || (scopeType === 'release' && releaseId))) {
  ...
  }, [showConnectEpicsModal, goalToConnectEpics, scopeType, piName, sprintId, releaseId]);
