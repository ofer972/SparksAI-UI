...
export default function CreateAgentJobView() {
 ...
 return (
 <div key={insightType.id} className="bg-surface rounded-lg shadow-md hover:shadow-lg transition-shadow border border-outline p-3 flex flex-col w-full">
 ...
 insightType.active ? 'bg-green-100 dark:bg-green-900/30 text-green-700 text-green-400' : 'bg-surface-secondary text-content-tertiary'
 }`}>
 ...
 <p className="text-xs text-content-muted italic mb-2">No filters required for this insight type.</p>
 )}
 ...
 <div className="inline-block animate-spin rounded-full h-10 w-10 border-b-2 border-blue-600 dark:border-blue-500 mb-4"></div>
 ...
 <div className="bg-danger-bg border-2 border-danger-border rounded-lg p-5 shadow-sm max-w-md">
 ...
 <div className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-950/20 dark:to-emerald-950/20 rounded-2xl border-2 border-positive-border p-4 shadow-lg flex flex-col overflow-hidden">
 ...
 <div className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950/20 dark:to-indigo-950/20 rounded-2xl border-2 border-blue-200 dark:border-blue-800 p-4 shadow-lg flex flex-col overflow-hidden">
 <div className="flex items-center gap-3 mb-3 flex-shrink-0">
 ...
 <h2 className="text-xl font-bold text-content-primary">Sprint Insights</h2>
 </div>
 ...
 <div className="bg-surface rounded-lg border border-outline p-6 text-center">
 <p className="text-content-muted font-medium">No Sprint Insights available</p>
 </div>
 )}
 </div>
 </div>
