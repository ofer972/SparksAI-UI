...
export default function UserDropdownMenu({ onOpenSettings }: UserDropdownMenuProps) {
 ...
 className="inline-flex items-center justify-center gap-2 h-7 px-2 rounded-full hover:bg-surface-secondary dark:hover:bg-slate-800 transition-colors focus:outline-none focus:ring-2 focus:ring-slate-300 dark:focus:ring-slate-600 focus:ring-offset-1"
 title={userName}
 aria-expanded={isOpen}
 aria-haspopup="true"
 >
 {/* User icon */}
 <div className="w-6 h-6 rounded-full bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center shadow-sm flex-shrink-0">
