...
<div className={`flex-1 flex flex-col ${isInsightCard ? 'bg-gradient-to-r from-surface to-surface-elevated' : 'bg-surface'}`}>
<div className={`h-full w-full flex flex-col ${enableContentOverflow ? 'overflow-visible' : 'overflow-auto'} ${isInsightCard ? '' : 'p-4'}`}>
{children}
</div>
</div>
