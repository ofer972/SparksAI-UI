...
export default function WidgetSelectorModal({
 ...
 <div className="bg-surface rounded-lg shadow-xl w-[90vw] max-w-5xl h-[85vh] flex flex-col">
 {/* Header */}
 <div className="flex-shrink-0 px-6 py-4">
 <div className="flex items-center justify-between mb-4">
 <h2 className="text-xl font-bold text-content-primary">Add Widget</h2>
 <button
 onClick={onClose}
 ...
 : 'border-outline hover:border-blue-500 dark:hover:border-blue-600'
 }`}
 >
 <div className="flex items-start justify-between mb-2">
 <h3 className="font-semibold text-content-primary">{report.report_name}</h3>
 {onUpdateWidgets && (
 ...
 <div className="flex items-center gap-1 border border-outline-strong rounded">
 <button
 onClick={(e) => {
 e.preventDefault();
 e.stopPropagation();
 ...
 className="px-2 py-1 text-content-tertiary hover:bg-surface-secondary disabled:opacity-50 disabled:cursor-not-allowed"
 >
 −
 </button>
 <span className="px-3 py-1 text-sm font-medium min-w-[2rem] text-center text-content-secondary">
 {currentCount}
 </span>
 <button
 onClick={(e) => {
 ...
 className="px-2 py-1 text-content-tertiary hover:bg-surface-secondary"
 >
 +
 </button>
 </div>
 ...
 {report.description && (
 <p className="text-sm text-content-tertiary mb-2 line-clamp-2">{report.description}</p>
 )}
 ...
 {onUpdateWidgets && (
 <div className="flex-shrink-0 px-6 py-4 border-t border-outline bg-surface flex items-center justify-between">
 ...
 <button
 onClick={onClose}
 className="px-4 py-2 text-content-secondary bg-surface-secondary rounded-md hover:bg-gray-200 hover:bg-surface-secondary transition-colors"
 >
 Cancel
 </button>
 <button
 ...
 className="px-4 py-2 bg-brand text-white rounded-md hover:bg-brand-hover disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
 >
 Apply
 </button>
 </div>
