...
export default function MultiPIFilter({ 
 ...
 <div className="border border-outline-strong rounded px-2 py-1 text-xs bg-surface-secondary text-content-tertiary">
 Loading...
 </div>
 </div>
 );
 ...
 return (
 <div className={`${className}`}>
 <div className="border border-outline dark:border-red-800 rounded px-2 py-1 text-xs bg-danger-bg text-danger-text">
 Error loading PIs
 </div>
 </div>
 );
 ...
 className="border border-outline-strong rounded px-2 py-1 text-xs bg-surface-elevated text-content-primary hover:bg-surface-secondary focus:outline-none focus:ring-2 focus:ring-brand focus:border-blue-500 min-w-[120px] text-left flex items-center justify-between"
 >
 <span>
 ...
 {isOpen && (
 <div className="absolute top-full left-0 mt-1 w-64 bg-surface border border-outline-strong rounded shadow-lg z-50">
 ...
 <label
 key={pi.pi_name}
 className={`flex items-center px-3 py-2 text-xs hover:bg-surface-elevated text-content-secondary cursor-pointer ${
 ...
 disabled={isDisabled}
 className="mr-2 rounded border-outline-strong text-brand focus:ring-brand"
 />
 ...
 {selectedPIs.length > 0 && (
 <div className="p-2 border-t border-outline bg-surface-elevated/50">
