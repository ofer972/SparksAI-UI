...
function MetricCard({ 
 ...
 const getColorClass = () => {
 if (color === 'red') return 'text-danger-text';
 if (color === 'yellow') return 'text-yellow-600 text-yellow-400';
 if (color === 'green') return 'text-positive-text';
 ...
 return (
 <div 
 className="relative group flex-1 bg-gradient-to-br from-surface to-surface-elevated rounded-lg border border-outline shadow-sm hover:shadow-md hover:border-blue-300 dark:hover:border-blue-700 transition-all duration-200 p-2 sm:p-3 flex flex-col items-center justify-center text-center h-full min-w-0"
 ...
 <div className="text-[10px] sm:text-xs text-content-secondary text-center mb-1 sm:mb-2">
 ...
 <div className="h-6 sm:h-8 w-12 sm:w-16 bg-gray-200 bg-surface-elevated rounded"></div>
 </div>
 ...
 <span 
 className="text-[10px] sm:text-xs font-semibold text-content-secondary text-left leading-tight" 
 title={dep.team}
 >
 {dep.team}
 </span>
 <span className="text-[10px] sm:text-xs font-bold text-content-primary bg-surface-secondary px-0.5 sm:px-1 py-0.5 rounded whitespace-nowrap flex-shrink-0 ml-auto">
 {dep.uncompletedIssues}
 </span>
 </div>
 
 {/* Progress bar visualization */}
 <div className="w-full bg-gray-200 bg-surface-elevated rounded-full h-0.5 sm:h-1 overflow-hidden">
 <div 
 ...
 {/* Title at bottom */}
 <div className="text-[10px] sm:text-xs text-content-primary break-words text-center leading-tight">
 {title}
 </div>
 </div>
 );
...
export default function PIMetrics({ piName, teamName, isGroup, selectedMetrics, singleRowLayout = false, refreshKey }: PIMetricsProps) {
 ...
 <div 
 key={i} 
 className="bg-gradient-to-br from-surface to-surface-elevated rounded-lg border border-outline shadow-sm p-2 sm:p-3 flex flex-col items-center text-center h-full min-w-0 animate-pulse"
 ...
 <p className="text-xs text-content-secondary font-semibold">Error loading metrics</p>
 </div>
 </div>
 );
 }
 ...
 title: (
 <>
 <span className="font-bold text-content-primary">PI Outbound</span>{' '}
 <span className="text-content-primary">Dependencies</span>
 </>
 ),
 ...
 title: (
 <>
 <span className="font-bold text-content-primary">PI Inbound</span>{' '}
 <span className="text-content-primary">Dependencies</span>
 </>
 ),
