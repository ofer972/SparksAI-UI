...
export default function GoalsConfirmationModal({
  ...
  const iconTextColor = variant === 'danger' ? 'text-red-600' : 'text-blue-600';
  const buttonColor = variant === 'danger' ? 'bg-red-600 hover:bg-red-700' : 'bg-blue-600 hover:bg-blue-700';
