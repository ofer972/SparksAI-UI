...
const IssuesByPriorityView: React.FC<IssuesByPriorityViewProps> = ({
 ...
 <p className="font-semibold text-content-primary mb-1">{name}</p>
 <p className="text-content-tertiary">{value} issues ({percentage}%)</p>
 </div>
 );
 }
 return null;
 ...
 <h3 className="text-lg font-semibold text-content-primary">Issues by Priority</h3>
 ...
 layout="vertical"
 iconType="circle"
 wrapperStyle={{ fontSize: '12px', color: isDark ? '#cbd5e1' : '#374151' }}
 />
 </PieChart>
 </ResponsiveContainer>
 ) : (
