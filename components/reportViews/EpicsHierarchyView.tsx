...
const EpicsHierarchyView: React.FC<EpicsHierarchyViewProps> = ({
 ...
 className="w-48 px-2 py-1 border border-outline-strong bg-surface-elevated text-content-primary rounded text-xs focus:outline-none focus:ring-1 focus:ring-brand"
 />
 </ReportFilterField>
 </ReportFiltersRow>
 );
 ...
 <p className="mt-3 text-content-tertiary text-sm">Loading hierarchy data...</p>
 </div>
 )}
