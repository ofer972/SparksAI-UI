...
const ActiveSprintSummaryView: React.FC<ActiveSprintSummaryViewProps> = ({
 ...
 return (
 <div
 className="text-sm text-brand font-medium hover:text-blue-800 hover:text-blue-300 hover:underline cursor-pointer"
 onClick={(e) => {
 e.stopPropagation();
 ...
 width: '120px',
 render: (value) => {
 if (!value) return <div className="text-sm text-content-muted text-center">-</div>;
 try {
 ...
 return <div className="text-sm text-content-secondary">{String(value)}</div>;
 }
 },
 },
 {
 ...
 if (total === 0) {
 return (
 <div className="text-sm text-content-muted text-center">-</div>
 );
 }
 ...
 <div className="w-full max-w-[180px] h-3 bg-gray-200 bg-surface-elevated rounded-full overflow-hidden flex flex-row">
 {done > 0 && (
 <div
 ...
 return (
 <div className="text-sm text-center font-bold text-content-tertiary">
 -
 </div>
 );
 }
 ...
 let colorClass = 'text-content-secondary';
 if (progressColor === 'green') {
 colorClass = 'text-positive-text font-bold';
 } else if (progressColor === 'yellow') {
 colorClass = 'text-yellow-600 text-yellow-400 font-bold';
 } else if (progressColor === 'red') {
 colorClass = 'text-danger-text font-bold';
 } else {
 ...
 return (
 <div className="text-sm text-positive-text font-bold text-center">
 {val.toLocaleString()}
 </div>
 );
 }
 ...
 return (
 <div
 className="text-sm font-bold text-positive-text hover:text-green-800 dark:hover:text-green-300 underline cursor-pointer text-center"
 onClick={handleClick}
 ...
 return (
 <div
 className="text-sm font-bold text-brand hover:text-blue-800 hover:text-blue-300 underline cursor-pointer text-center"
 onClick={handleClick}
 title={keysArray.join(', ')}
 >
 {val.toLocaleString()}
 ...
 width: '120px',
 render: (val) => {
 if (!val) return <div className="text-sm text-content-muted text-center">-</div>;
 try {
 ...
 return <div className="text-sm text-content-secondary">{String(val)}</div>;
 }
 },
 };
 ...
 if (isPercentage) {
 return (
 <div className="text-sm text-content-secondary text-center font-medium">
 {numVal}%
 </div>
 );
 }
 ...
 let hoverColorClass = 'hover:text-blue-800 hover:text-blue-300';
 if (isIssuesAdded && issuesAddedColor) {
 if (issuesAddedColor === 'red') {
 colorClass = 'text-danger-text';
 hoverColorClass = 'hover:text-red-800 hover:text-red-300';
 } else if (issuesAddedColor === 'yellow') {
 colorClass = 'text-yellow-600 text-yellow-400';
 hoverColorClass = 'hover:text-yellow-800 dark:hover:text-yellow-300';
 } else if (issuesAddedColor === 'default') {
 colorClass = 'text-brand';
 hoverColorClass = 'hover:text-blue-800 hover:text-blue-300';
 }
 }
 ...
 if (isIssuesAdded) {
 return (
 <div className="text-sm font-bold text-content-muted text-center">
 {numVal.toLocaleString()}
 </div>
 );
 }
