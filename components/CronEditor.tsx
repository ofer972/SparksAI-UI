  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex items-center justify-between">
        <div>
          <label htmlFor="cron-enabled" className="block text-sm font-medium text-content-primary">
        ...
        <div className="flex items-center">
          ...
          />
          <label htmlFor="cron-enabled" className="ml-3 text-sm font-medium text-content-secondary">
          ...
          <div className="bg-surface border border-outline rounded-lg p-4">
            ...
            <div className="flex items-center gap-3">
              <div className="flex flex-col">
                <label className="text-xs font-medium text-content-secondary mb-1">Hour</label>
                <input
                  type="number"
                  min="0"
                  max="23"
                  ...
                  className="w-20 px-3 py-2 text-center border border-outline rounded-lg focus:outline-none focus:ring-2 focus:ring-brand focus:border-transparent font-mono text-lg"
                />
                <span className="text-xs text-content-tertiary mt-1 text-center">0-23</span>
              </div>
              <span className="text-3xl text-gray-300 font-light mt-3">:</span>
              <div className="flex flex-col">
                <label className="text-xs font-medium text-content-secondary mb-1">Minute</label>
                <input
                  type="number"
                  min="0"
                  max="59"
                  ...
                  className="w-20 px-3 py-2 text-center border border-outline rounded-lg focus:outline-none focus:ring-2 focus:ring-brand focus:border-transparent font-mono text-lg"
                />
                <span className="text-xs text-content-tertiary mt-1 text-center">0-59</span>
              </div>
            ...
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="text-xs text-brand hover:text-blue-700 font-medium px-2 py-1 hover:bg-blue-50 rounded transition-colors"
                >
                  Select All
                </button>
                <button
                  ...
                  className="text-xs text-content-secondary hover:text-content-secondary font-medium px-2 py-1 hover:bg-surface-secondary rounded transition-colors"
                >
                  Clear
                </button>
              </div>
                ...
                <button
                  ...
                  className={`px-3 py-3 rounded-lg text-xs font-semibold transition-all ${
                    selectedDays.includes(day.value)
                      ...
                      : 'bg-surface-secondary text-content-secondary hover:bg-gray-200 hover:shadow'
                  }`}
                >
