...
export default function LoginPage() {
 ...
 <h1 className="text-2xl font-semibold mb-4 text-center text-content-primary">Login</h1>
 {error && (
 ...
 className="inline-block w-full text-center p-2 border border-outline-strong rounded bg-surface-elevated text-content-primary hover:bg-surface-secondary transition-colors"
 >
